...
;var IIInsomniaCityPickerEdit = function(options){
    ...
    this.template = $('<div class="IIInsomnia-city-picker" id="IIInsomnia_city_picker" style="left:'+this.settings.city_left+'"><div class="IIInsomnia-hot-wrap"><p>热门城市</p><ul id="IIInsomnia_hot_city"></ul></div><div class="line"></div><div class="IIInsomnia-wrap"><p>选择省份</p><ul class="IIInsomnia-province-wrap" id="IIInsomnia_province_wrap"></ul></div></div>');
...
console.log(that.settings.city_left)
        ...
        that.settings.target.attr('readonly', false);
    ...
    buildCityTpl: function(cur_province){
        ...
        cur_province.find('.IIInsomnia-city-wrap').html(city_html).show();
    },
