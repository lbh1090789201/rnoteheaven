module Api
  class FoodpackageAlbumnsController < ApiController
    ...
    def create
      ...
      # puts 'wwwwwwwwwwwwwwwwwwwwwwwwww'+foodpackageALbumn_params.to_json.to_s
      foodpackageALbumn = FoodpackageAlbumn.new(
                                  :image =>params[:image],
                                  :food_package_id =>params[:food_package_id])

      unless foodpackageALbumn.save
        puts '餐厅信息上传失败'
        render json: {
                   success: false,
                   errors: ['套餐相册上传失败'],
      ...
      fcf = {
          id: foodpackageALbumn.id,
          image: foodpackageALbumn.image,
      }
      render json: {
                 success: true,
                 info: '餐厅信息上传成功',
    ...
    private
    def foodpackageALbumn_params
      params.permit(:image,:food_package_id)
