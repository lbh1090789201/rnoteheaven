...
#for token_based_authentication
...
#web theme, discarded 20160530
#gem 'web-app-theme', path: 'vendor/gems'

# weixin plugin
# gem 'weixin_rails_middleware'
# gem 'weixin_authorize', path: 'vendor/gems'
